...
-- -----------------------------------------------------
-- Table `bruno_minelli_db`.`TSA_PARAMETROS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bruno_minelli_db`.`TSA_PARAMETROS` ;

CREATE TABLE IF NOT EXISTS `bruno_minelli_db`.`TSA_PARAMETROS` (
...
-- -----------------------------------------------------
-- Table `bruno_minelli_db`.`TSA_TIPO_LIDER`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bruno_minelli_db`.`TSA_TIPO_LIDER` ;

CREATE TABLE IF NOT EXISTS `bruno_minelli_db`.`TSA_TIPO_LIDER` (
...
-- -----------------------------------------------------
-- Table `bruno_minelli_db`.`TSA_DISTRIBUIDOR`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bruno_minelli_db`.`TSA_DISTRIBUIDOR` ;

CREATE TABLE IF NOT EXISTS `bruno_minelli_db`.`TSA_DISTRIBUIDOR` (
  ...
  CONSTRAINT `fk_TSA_DISTRIBUIDOR_TSA_TIPO_LIDER1`
    ...
    REFERENCES `bruno_minelli_db`.`TSA_TIPO_LIDER` (`id_tipo_lider`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_TSA_DISTRIBUIDOR_TSA_DISTRIBUIDOR1`
    FOREIGN KEY (`id_distribuidor_padre`)
    REFERENCES `bruno_minelli_db`.`TSA_DISTRIBUIDOR` (`id_distribuidor`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `bruno_minelli_db`.`TSA_HISTORICO_DISTRIBUIDOR`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bruno_minelli_db`.`TSA_HISTORICO_DISTRIBUIDOR` ;

CREATE TABLE IF NOT EXISTS `bruno_minelli_db`.`TSA_HISTORICO_DISTRIBUIDOR` (
...
-- -----------------------------------------------------
-- Table `bruno_minelli_db`.`TSA_EMPLEADO`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bruno_minelli_db`.`TSA_EMPLEADO` ;

CREATE TABLE IF NOT EXISTS `bruno_minelli_db`.`TSA_EMPLEADO` (
...
-- -----------------------------------------------------
-- Table `bruno_minelli_db`.`TSA_COMISION`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bruno_minelli_db`.`TSA_COMISION` ;

CREATE TABLE IF NOT EXISTS `bruno_minelli_db`.`TSA_COMISION` (
